...
void publish_message(MQTT::Client<MQTTNetwork, Countdown>* client) {
    ...
    if (gesture_index == 0) {
        ...
        sprintf(buff, "sequence number: #%d, Ring", message_num);
        ...
        sprintf(buff, "sequence number: #%d, Slope", message_num);
        ...
        sprintf(buff, "sequence number: #%d, Up", message_num);
...
void mqtt_main()
{
  wifi = WiFiInterface::get_default_instance();
    ...
    const char* host = "192.168.160.32";
        ...
        if (checkled1 == 1) {
            ...
            if (message_num == 0) {
              ...
              while (i < 50) {
                  ...
                  if (detect_angle > 30) feature1[i] = '1';
                  else feature1[i] = '0';
                  i++;
                  if (i == 50) i = 0;
              ...
              while (i < 50) {
                  ...
                  offset = sqrt((double)pDataXYZ[0]*(double)pDataXYZ[0]+(double)pDataXYZ[1]*(double)pDataXYZ[1]+(double)pDataXYZ[2]*(double)pDataXYZ[2]);
                  detect_angle = 57.3*acos((double)pDataXYZ[2]/offset);
                  if (detect_angle > 30) feature2[i] = '1';
                  else feature2[i] = '0';
                  i++;
                  if (i == 50) i = 0;
                  ThisThread::sleep_for(10ms);
              ...
              while (i < 50) {
                  ...
                  offset = sqrt((double)pDataXYZ[0]*(double)pDataXYZ[0]+(double)pDataXYZ[1]*(double)pDataXYZ[1]+(double)pDataXYZ[2]*(double)pDataXYZ[2]);
                  detect_angle = 57.3*acos((double)pDataXYZ[2]/offset);
                  if (detect_angle > 30) feature3[i] = '1';
                  else feature3[i] = '0';
                  i++;
                  if (i == 50) i = 0;
                  ThisThread::sleep_for(10ms);
              ...
              while (i < 50) {
                  ...
                  offset = sqrt((double)pDataXYZ[0]*(double)pDataXYZ[0]+(double)pDataXYZ[1]*(double)pDataXYZ[1]+(double)pDataXYZ[2]*(double)pDataXYZ[2]);
                  detect_angle = 57.3*acos((double)pDataXYZ[2]/offset);
                  if (detect_angle > 30) feature4[i] = '1';
                  else feature4[i] = '0';
                  i++;
                  if (i == 50) i = 0;
                  ThisThread::sleep_for(10ms);
              ...
              while (i < 50) {
                  ...
                  offset = sqrt((double)pDataXYZ[0]*(double)pDataXYZ[0]+(double)pDataXYZ[1]*(double)pDataXYZ[1]+(double)pDataXYZ[2]*(double)pDataXYZ[2]);
                  detect_angle = 57.3*acos((double)pDataXYZ[2]/offset);
                  if (detect_angle > 30) feature5[i] = '1';
                  else feature5[i] = '0';
                  i++;
                  if (i == 50) i = 0;
                  ThisThread::sleep_for(10ms);
